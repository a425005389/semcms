...
<table width="98%" class="table" cellpadding="0" cellspacing="0">
      <tr>
          <td colspan="4"  class="tdsbg"><img src="SC_Page_Config/Image/icons/coins.png" align="absmiddle" />  <span class="red">信息分类添加</span> </td>
  </tr>
   ...
   <tr><td width="200" align="center">分类URL(seo)</td><td><input name="category_url" type="text" id="category_url" size="40" >   <span class="red"> 词与词之间用 - 链接！如：a-b-c-d-e 只支持 A-Z,a-z,0-9,- 的组合 注意：关于我们的链接地址必须为 “about”</span></td></tr>
...
<table width="98%" class="table" cellpadding="0" cellspacing="0">
      <tr>
          <td colspan="4"  class="tdsbg"><img src="SC_Page_Config/Image/icons/coins.png" align="absmiddle" />  <span class="red">信息分类修改</span> </td>
  </tr>
  <tr><td width="200" align="center">分类名称</td><td><input name="category_name" type="text" id="category_name" size="40" value="<?php echo $row['category_name']; ?>"    >  <span class="red"> *</span></td></tr>
   ...
   <tr><td width="200" align="center">分类URL(seo)</td><td><input name="category_url" type="text" id="category_url" size="40" value="<?php echo $row['category_url']; ?>" >   <span class="red"> 词与词之间用 - 链接！如：a-b-c-d-e 只支持 A-Z,a-z,0-9,- 的组合 注意：关于我们的链接地址必须为 “about”</span></td></tr>
...
<table width="98%" class="table" cellpadding="0" cellspacing="0">
      <tr>
          <td colspan="4"  class="tdsbg"><img src="SC_Page_Config/Image/icons/coins.png" align="absmiddle" />  <span class="red">信息分类管理</span>  <span id="uploads" class="sr"><a href="?type=add&pid=<?php echo $_GET["pid"]; ?>&lgid=<?php echo $_GET["lgid"] ?>"><img src="SC_Page_Config/Image/icons/add.png" align="absmiddle" />增加一级分类</a></span></td>
  </tr>
    <tr><td>排序</td><td>图片</td><td>名称</td><td>操作</td></tr>
   <?php echo get_str('2',$_GET["lgid"],"&types=n",$db_conn);?>
