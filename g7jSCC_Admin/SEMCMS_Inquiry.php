...
<table width="98%" class="table" cellpadding="0" cellspacing="0">
  ...
  <tr>
   ...
   if($Searchp!==""){  
      ...
      $sql=$db_conn->query("select * from sc_msg where msg_email like '%".$Searchp."%'");    

   }else{

      $sql=$db_conn->query("select * from sc_msg order by ID desc");       
