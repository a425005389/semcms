...
<table width="98%" class="table" cellpadding="0" cellspacing="0">
   ...
   <tr><td width="200" align="center">文件名称<span class="red"> *</span></td><td><input name="down_name" type="text" id="down_name" size="100"   >  </td></tr>
...
<table width="98%" class="table" cellpadding="0" cellspacing="0">
   ...
   <tr>
   <tr><td width="200" align="center">文件名称<span class="red"> *</span></td><td><input name="down_name" type="text" id="down_name" size="100" value="<?php echo $row["down_name"] ?>"   >  </td></tr>
