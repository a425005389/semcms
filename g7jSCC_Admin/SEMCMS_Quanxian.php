...
<table width="98%" class="table" cellpadding="0" cellspacing="0">
      <tr>
          <td colspan="4"  class="tdsbg"><img src="SC_Page_Config/Image/icons/coins.png" align="absmiddle" />  <span class="red">权限分类添加</span> </td>
  </tr>
...
<table width="98%" class="table" cellpadding="0" cellspacing="0">
      <tr>
          <td colspan="4"  class="tdsbg"><img src="SC_Page_Config/Image/icons/coins.png" align="absmiddle" />  <span class="red">权限分类管理</span>  <span id="uploads" class="sr"><a href="?type=add&pid=<?php echo $_GET["pid"]; ?>&lgid=<?php echo $_GET["lgid"] ?>"><img src="SC_Page_Config/Image/icons/add.png" align="absmiddle" />增加一级分类</a></span></td>
  </tr>
   <?php echo get_str('3',$_GET["lgid"],"&types=o",$db_conn);?>
